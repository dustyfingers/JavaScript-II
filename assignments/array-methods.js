...
const sum = ticketPriceTotal.reduce((total, amount) => total + amount);
console.log(sum);
...
// Problem 2
let newRunners = runners.map(runner => runner.first_name + ' BOO!');
console.log(newRunners);

// Problem 3
runners.filter(runner => runner.id === 43 && console.log(runner));